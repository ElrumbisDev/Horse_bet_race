    ...
    <main className="min-h-screen bg-gradient-to-br from-green-600 via-yellow-500 to-red-500 p-8 text-white">
      ...
      <SignedIn>
        <div className="justify-centered flex justify-between items-start mb-12">
          ...
          <div className="bg-[#008248] rounded-full w-32 h-32 sm:w-40 sm:h-40 flex flex-col justify-center items-center text-white text-center">
            <div className="text-xs sm:text-sm font-medium opacity-80">Mes Points</div>
            <div className="text-2xl sm:text-3xl font-bold">{userPoints}</div>
          </div>
        ...
        <div className="mx-auto max-w-6xl space-y-8 md:space-y-0 md:grid md:grid-cols-4 md:gap-6">
          <section
          onClick={() => {
            setActiveSection('parier');
            document.getElementById('box-user')?.scrollIntoView({ behavior: 'smooth' });
          }}
            className={`rounded-lg p-8 shadow-xl cursor-pointer transition-transform hover:scale-[1.03] ${
              activeSection === 'parier'
                ? 'bg-gradient-to-tr from-emerald-500 to-green-700'
          ...
          <section
          onClick={() => {
            setActiveSection('inscrire');
            document.getElementById('box-user')?.scrollIntoView({ behavior: 'smooth' });
          }}
            className={`rounded-lg p-8 shadow-xl cursor-pointer transition-transform hover:scale-[1.03] ${
              activeSection === 'inscrire'
                ? 'bg-gradient-to-tr from-amber-500 to-red-600'
                : 'bg-gradient-to-tr from-amber-400 to-red-500'
            }`}
          >
          ...
          <section className="rounded-lg p-8 shadow-xl bg-gradient-to-tr from-blue-400 to-indigo-600">
          ...
          <section className="rounded-lg p-8 shadow-xl bg-gradient-to-tr from-teal-400 to-emerald-600">
        ...
        <div id="box-user" className="mt-12 max-w-3xl mx-auto bg-white rounded-lg p-8 shadow-lg text-gray-900">
          {activeSection === 'parier' && nextRace && (
            <>
              ...
              <form onSubmit={handleSubmitBet} className="flex flex-col gap-4 max-w-sm">
                ...
                <p className="mb-2 font-semibold">Cote : {slotCount}</p>
                <p className="mb-2 font-semibold">Gains potentiels: {slotCount*betAmount}</p>
